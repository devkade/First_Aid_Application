...
public class QuizNB extends AppCompatActivity {
    private final numQuiz numquiz1 = new numQuiz();
    private List<List<String>> setB = numquiz1.getnumB();
    public odapNote odapNB =new odapNote();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nums= setB.get(count).get(2);
        ...
        quiz_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (setB.get(count).get(3) == "1") {
                    Toast.makeText(QuizNB.this, "정답입니다!", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(QuizNB.this, "틀렸습니다. 답 : "+ setB.get(count).get(3), Toast.LENGTH_SHORT).show();
                    odapNB.setOdapNB(setB.get(count));
                }
                count++;
                if(count< setB.size()) {
